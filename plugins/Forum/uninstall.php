...
$uninstall_db_data[] = "
DROP TABLE IF EXISTS `".PREFIX."plugin_forum_cat`;
";
$uninstall_db_data[] = "
DROP TABLE IF EXISTS `".PREFIX."plugin_forum_groups`;
";
$uninstall_db_data[] = "
DROP TABLE IF EXISTS `".PREFIX."plugin_forum_images`;
";
$uninstall_db_data[] = "
DROP TABLE IF EXISTS `".PREFIX."plugin_forum_posts`;
";
$uninstall_db_data[] = "
DROP TABLE IF EXISTS `".PREFIX."plugin_forum_post_replies`;
";
$uninstall_db_data[] = "
DROP TABLE IF EXISTS `".PREFIX."plugin_forum_settings`;
";
$uninstall_db_data[] = "
DROP TABLE IF EXISTS `".PREFIX."plugin_forum_tracker`;
";
$uninstall_db_data[] = "
DROP TABLE IF EXISTS `".PREFIX."plugin_forum_post_tracker`;
";
