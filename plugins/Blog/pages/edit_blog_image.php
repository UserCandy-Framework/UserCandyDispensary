<?php
/**
* UserApplePie v4 Blog View Plugin Edit Image
*
	...
	<?php if($data['edit_image'] != ""){ ?>
		<div class="card mb-3">
			...
			<div class="card-body text-center">
				<img alt="Blog Pic" src="<?php echo SITE_URL.IMG_DIR_BLOG.$data['edit_image']; ?>" class="rounded img-fluid">
				<hr>
				<?php
						...
						if($data['edit_image'] != $data['main_image']){
							...
							$button_display = Form::open(array('method' => 'post', 'style' => 'display:inline'));
								...
								$button_display .= " <input type='hidden' name='token_blog' value='$csrf_token' /> ";
							...
							$button_display_delete = Form::open(array('method' => 'post', 'style' => 'display:inline'));
								...
								$button_display_delete .= " <input type='hidden' name='token_blog' value='$csrf_token' /> ";
