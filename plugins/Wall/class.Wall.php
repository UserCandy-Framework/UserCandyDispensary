...
class WallModel extends Models {
  ...
  public function sweets(){
    ...
    $sweets = "
      ...
      FROM ".PREFIX."sweets swe
        LEFT JOIN ".PREFIX."plugin_friends fri
  ...
  */
  public function forum_post_replies(){
    ...
    $forum_post_replies = "
      ...
      FROM ".PREFIX."plugin_forum_post_replies fpr
        LEFT JOIN ".PREFIX."plugin_friends fri
  ...
  */
  public function addStatus($userID = '', $status_feeling = '', $status_content = ''){
    return $this->db->insert(PREFIX.'plugin_status', array('status_userID' => $userID, 'status_feeling' => $status_feeling, 'status_content' => $status_content));
  }
  ...
  */
  public function updateStatus($userID = '', $id = '', $status_feeling = '', $status_content = ''){
    return $this->db->update(PREFIX.'plugin_status', array('status_feeling' => $status_feeling, 'status_content' => $status_content), array('id' => $id, 'status_userID' => $userID));
  }
