...
(empty($get_var_2)) ? $limit = "10" : $limit = $get_var_2;
  ...
  $data['friends'] = $WallModel->getFriendsIDs($u_id, '15');
  $data['suggested_friends'] = $WallModel->getSuggestedFriends($u_id);
  $data['recent'] = $WallModel->getRecent($u_id, $limit);
  $data['recent_total'] = $WallModel->getRecentTotal($u_id);
    ...
    if(Csrf::isTokenValid('status')) {
      ...
      if($data['action'] == 'status_update'){
        if($WallModel->addStatus($u_id, $status_feeling, $status_content)){
          ...
          ErrorMessages::push(Language::show('status_update_error', 'Welcome'), 'Wall');
        }
      }else if($data['action'] == 'status_edit' && isset($edit_status_id)){
        /** Get data for status user is editing **/
        $get_status = $WallModel->getStatus($u_id, $edit_status_id);
        ...
        if($WallModel->updateStatus($u_id, $edit_status_id, $status_feeling, $status_content)){
          /** Success Message Display **/
          SuccessMessages::push(Language::show('status_update_success', 'Welcome'), 'Wall');
        }else{
          /** Error Message Display **/
    ...
    <div class='card mb-3'>
      ...
      <div class='card-body'>
          <?php echo $data['welcome_message']; ?>
              ...
              <!-- BBCode Buttons -->
              <?=BBCode::displayButtons('status_content')?>
            ...
            if($recent->RP_03 == "Forum_Topic"){
              ...
              echo "<div class='card border-secondary mb-3'>";
                echo "<div class='card-header'>";
                  ...
                  echo "</a>";
                  echo " $online_check <a href='".SITE_URL."Profile/{$recent_userName}'>$recent_userName</a> sweeted a Forum Topic..";
                echo "</div>";
              ...
              echo "<div class='card border-secondary mb-3'>";
                echo "<div class='card-header'>";
                  echo "<a href='".SITE_URL."Profile/{$recent_userName}'>";
                    echo "<img src=".SITE_URL.IMG_DIR_PROFILE.$recent_userImage." class='rounded' style='height: 25px'>";
                  echo "</a>";
                  echo " $online_check <a href='".SITE_URL."Profile/{$recent_userName}'>$recent_userName</a> sweeted a Forum Topic Reply..";
                echo "</div>";
                echo "<div class='card-body'>";
                  echo "<strong>";
            ...
            echo "<div class='card border-secondary mb-3'>";
              echo "<div class='card-header'>";
                echo "<a href='".SITE_URL."Profile/{$recent_userName}'>";
                  echo "<img src=".SITE_URL.IMG_DIR_PROFILE.$recent_userImage." class='rounded' style='height: 25px'>";
                echo "</a>";
                echo " $online_check <a href='".SITE_URL."Profile/{$recent_userName}'>$recent_userName</a> Created a new Forum Post..";
              echo "</div>";
              echo "<div class='card-body'>";
                echo "<strong>";
            ...
            echo "<div class='card border-secondary mb-3'>";
              echo "<div class='card-header'>";
                echo "<a href='".SITE_URL."Profile/{$recent_userName}'>";
                  echo "<img src=".SITE_URL.IMG_DIR_PROFILE.$recent_userImage." class='rounded' style='height: 25px'>";
                echo "</a>";
                echo " $online_check <a href='".SITE_URL."Profile/{$recent_userName}'>$recent_userName</a> Replied to a Forum Post..";
              echo "</div>";
              echo "<div class='card-body'>";
                echo "<strong>";
//  TODO  Firgure out what page the post reply was on so that it can center that post
            ...
            echo "<div class='card border-secondary mb-3'>";
              echo "<div class='card-header'>";
                echo "<a href='".SITE_URL."Profile/{$recent_userName}'>";
                  echo "<img src=".SITE_URL.IMG_DIR_PROFILE.$recent_userImage." class='rounded' style='height: 25px'>";
                echo "</a>";
                echo " $online_check <a href='".SITE_URL."Profile/{$recent_userName}'>$recent_userName</a> changed their default photo..";
              echo "</div>";
              echo "<div class='card-body'>";
            ...
            echo "<div class='card border-secondary mb-3'>";
              echo "<div class='card-header'>";
                echo "<a href='".SITE_URL."Profile/{$recent_userName}'>";
                  echo "<img src=".SITE_URL.IMG_DIR_PROFILE.$recent_userImage." class='rounded' style='height: 25px'>";
                echo "</a>";
                echo " $online_check <a href='".SITE_URL."Profile/{$recent_userName}'>$recent_userName</a>";
              ...
              echo "<div class='card-footer'>";
                ...
                echo "<div class='float-right'>";
                  ...
                  if($data['action'] != "status_edit" && $data['current_userID'] == $recent->RP_06){
                    echo Form::open(array('method' => 'post', 'action' => SITE_URL.'Wall', 'style' => 'display:inline'));
