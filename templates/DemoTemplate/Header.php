...
<html lang="<?php echo LANGUAGE_CODE; ?>">
    <head>
        ...
        ";?>
        <link rel='shortcut icon' href='<?=Url::customPath('templates','DemoTemplate')?>images/favicon.ico'>
        <?php
        ...
        <?=Assets::css([
            ...
            Url::customPath('templates','DemoTemplate').'css/style.css'
        ])?>
        <?=(isset($css)) ? $css : ""?>
        <?=(isset($header)) ? $header : ""?>
    </head>
    <body class="sticky-footer bg-light" id="page-top">
      <div class="navbar navbar-expand-lg navbar-dark bg-dark">
          ...
          <img class='navbar-brand' src='<?php echo Url::customPath('templates','DemoTemplate'); ?>images/logo.png'>
          </a>
